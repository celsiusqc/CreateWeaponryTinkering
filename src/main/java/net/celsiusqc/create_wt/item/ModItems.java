...
public class ModItems {
    ...
    public static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(CreateWeaponryTinkering.MOD_ID, name), item);
    }
    public static void registerModItems() {
        CreateWeaponryTinkering.LOGGER.info("Registering Items for " + CreateWeaponryTinkering.MOD_ID);
    }
    ...
    public static void registerItem(){
        ...
        ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_ANDESITE));

        final Item CRUSHED_NETHERITE_SCRAP = registerItem("crushed_netherite_scrap", new Item(new FabricItemSettings()));
        ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_NETHERITE_SCRAP));

        if (FabricLoader.getInstance().isModLoaded("ad_astra")) {

            final Item CRUSHED_RAW_CALORITE = registerItem("crushed_raw_calorite", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_CALORITE));

            final Item CRUSHED_RAW_DESH = registerItem("crushed_raw_desh", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_DESH));

            final Item CRUSHED_RAW_OSTRUM = registerItem("crushed_raw_ostrum", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_OSTRUM));
        ...
        if (!isCrushedRawMythrilLoaded && (FabricLoader.getInstance().isModLoaded("mythicmetals") || FabricLoader.getInstance().isModLoaded("createbigcannons"))) {
            ...
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_MYTHRIL));
        ...
        if (FabricLoader.getInstance().isModLoaded("indrev")) {
            ...
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_TUNGSTEN));
        ...
        if (FabricLoader.getInstance().isModLoaded("majruszsdifficulty")) {
            ...
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_ENDERIUM_SHARD));
        ...
        if (FabricLoader.getInstance().isModLoaded("mythicmetals")) {
            ...
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_MORKITE));

            final Item CRUSHED_RAW_ADAMANTITE = registerItem("crushed_raw_adamantite", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_ADAMANTITE));

            final Item CRUSHED_RAW_AQUARIUM = registerItem("crushed_raw_aquarium", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_AQUARIUM));

            final Item CRUSHED_RAW_BANGLUM = registerItem("crushed_raw_banglum", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_BANGLUM));

            final Item CRUSHED_RAW_CARMOT = registerItem("crushed_raw_carmot", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_CARMOT));

            final Item CRUSHED_RAW_KYBER = registerItem("crushed_raw_kyber", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_KYBER));

            final Item CRUSHED_RAW_MANGANESE = registerItem("crushed_raw_manganese", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_MANGANESE));

            final Item CRUSHED_RAW_MIDAS_GOLD = registerItem("crushed_raw_midas_gold", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_MIDAS_GOLD));

            final Item CRUSHED_RAW_ORICHALCUM = registerItem("crushed_raw_orichalcum", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_ORICHALCUM));

            final Item CRUSHED_RAW_PALLADIUM = registerItem("crushed_raw_palladium", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_PALLADIUM));

            final Item CRUSHED_RAW_PROMETHEUM = registerItem("crushed_raw_prometheum", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_PROMETHEUM));

            final Item CRUSHED_RAW_QUADRILLUM = registerItem("crushed_raw_quadrillum", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_QUADRILLUM));

            final Item CRUSHED_RAW_RUNITE = registerItem("crushed_raw_runite", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_RUNITE));

            final Item CRUSHED_RAW_STORMYX = registerItem("crushed_raw_stormyx", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_STORMYX));

            final Item CRUSHEDSTARRITE = registerItem("crushed_starrite", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHEDSTARRITE));

            final Item CRUSHED_UNOBTAINIUM = registerItem("crushed_unobtainium", new Item(new FabricItemSettings()));
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_UNOBTAINIUM));
        ...
        if (FabricLoader.getInstance().isModLoaded("betterend")) {
            ...
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_THALLASIUM));
        ...
        if (FabricLoader.getInstance().isModLoaded("betternether")) {
            ...
            ItemGroupEvents.modifyEntriesEvent(CreateWeaponryTinkering.GROUP).register(entries -> entries.add(CRUSHED_RAW_CINCINNASITE));
