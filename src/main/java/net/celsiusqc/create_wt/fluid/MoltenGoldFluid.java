...
public abstract class MoltenGoldFluid extends FlowableFluid {
    @Override
    ...
    public Fluid getStill() {
        return ModFluids.STILL_MOLTEN_GOLD;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.MOLTEN_GOLD_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
