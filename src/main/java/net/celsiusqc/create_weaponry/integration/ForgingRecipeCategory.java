...
public class ForgingRecipeCategory implements IRecipeCategory<ForgeRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(CreateWeaponry.MOD_ID, "forging");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(CreateWeaponry.MOD_ID, "textures/gui/forge_gui.png");
